...
original file:https://github.com/openai/retro/blob/master/retro/examples/discretizer.py
"""
...
class SonicDiscretizer(Discretizer):
    ...
    def __init__(self, env):
        super().__init__(env=env, combos=[['LEFT'], ['RIGHT'], ['LEFT', 'DOWN'], ['RIGHT', 'DOWN'],
                                          ['DOWN'], ['DOWN', 'B'], ['B'],['LEFT','B'],['RIGHT','B']])
    # determine 9 actions.
